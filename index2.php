        ...
        <ul class="sidebar-menu verttop">
            <li class="treeview active">
                ...
                <ul class="treeview-menu">
                    <li class="active"><a href="https://demo.smart-school.in/student/search"><i class="fa fa-angle-double-right"></i> Student Details</a></li>
                    ...
                    <li class=""><a href="https://demo.smart-school.in/admin/stdtransfer"><i class="fa fa-angle-double-right"></i> Promote Students</a></li>
                </ul>
            </li>
            <li class="treeview ">
                <a href="#">
