            ...
            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <form role="form" action="" method="post" class="">
										...
										<div class="col-sm-12">
                                            <div class="form-group">
                                                <label>Search</label>
                                                <input autofocus="" type="text" name="search_key" value="" name="search_text"  class="form-control" placeholder="Search by Inocme Head, Name, Amount, Date etc..." required>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
				...
				<div class="box box-info" id="exp">
                        ...
                        <div class="box-header ptbnull">
                            <h3 class="box-title titlefix"><i class="fa fa-money"></i> Income Result</h3>
                        </div>
                        <div class="box-body table-responsive">
							<div class="download_label">Income Result</div>
								...
								<table class="table table-striped table-bordered table-hover example dataTable no-footer" id="DataTables_Table_0" role="grid">
								   ...
								   <thead>
										<tr role="row">
											...
											<th class="sorting_disabled" rowspan="1" colspan="1" style="width: 160px;">Income Head</th>
									...
									<?php
										...
										$q="SELECT * FROM income_add WHERE 	income_date>='$date_from' AND income_date<='$date_to'";
									...
									?>										
										...
										<tr role="row" class="">
											...
											<td><?php echo $result['income_head']?></td>
											<td> <?php echo $result['income_name']?> </td>
											<td class="pull-right"><?php echo $result['income_amount']?> </td>
										</tr>
									
									<?php
									 $sum += $result['income_amount'];
										}
								...
								<table class="table table-striped table-bordered table-hover example dataTable no-footer" id="DataTables_Table_0" role="grid">
								   ...
								   <thead>
									...
									<?php
										...
										$q="SELECT * FROM income_add WHERE income_head LIKE '%$search_key%' or income_date LIKE '%$search_key%'
											   or income_amount LIKE '%$search_key%' or income_name LIKE '%$search_key%'";
