	...
	<section class="content-header">
		...
		<?php
				...
				if(isset($_POST['submit'])){
						...
						$q="INSERT INTO students_info (admission_number,roll_number,class,section,first_name,last_name,gender,
									dob,category,religion,cast,mobile_no,email,admission_date,rte,
									father_name,father_phone,father_occup,mother_name,mother_phone,mother_occup,
									guardian_is,guardian_name,guardian_relation,guardian_email,guardian_phone,guardian_occup,guardian_address)
						
						VALUES ('$admission_number','$roll_number','$class','$section','$first_name','$last_name','$gender',
								'$dob','$category','$religion','$cast','$mobile_no','$email','$admission_date','$rte',
								'$father_name','$father_phone','$father_occup','$mother_name','$mother_phone','$mother_occup',
								'$guardian_is','$guardian_name','$guardian_relation','$guardian_email','$guardian_phone','$guardian_occup','$guardian_address')";
						...
						if($inserted){
							//echo"<script>window.location='student_admission.php';</script>";
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input autofocus="" id="" name="admission_number" placeholder="" type="text" class="form-control"  value="" required />
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="roll_no" name="roll_number" placeholder="" type="text" class="form-control"  value="" required />
                                                <span class="text-danger"></span>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="first_name" name="first_name" placeholder="" type="text" class="form-control"  value="" required/>
                                                <span class="text-danger"></span>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="last_name" name="last_name" placeholder="" type="text" class="form-control"  value="" required/>
                                                <span class="text-danger"></span>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input id="religion" name="religion" placeholder="" type="text" class="form-control"  value="" required/>
                                                <span class="text-danger"></span>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input id="cast" name="cast" placeholder="" type="text" class="form-control"  value="" required/>
                                                <span class="text-danger"></span>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="mobile_no" name="mobile_no" placeholder="" type="text" class="form-control"  value="" required/>
                                                <span class="text-danger"></span>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="email" name="email" placeholder="" type="text" class="form-control"  value="" required/>
                                                <span class="text-danger"></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="admission_date" name="admission_date" placeholder="" type="text" class="form-control"  value="<?php echo date('d/m/y');?>" readonly="readonly" required/>
                                                <span class="text-danger"></span>
                                            </div>
                                        </div>  
                                        ...
                                        <div class="col-md-3 col-xs-12">
                                            ...
                                            <div class="radio" style="margin-top: 2px;">
                                                <label><input class="radio-inline" type="radio" name="rte" value="Yes"  required>Yes</label>
                                                <label><input class="radio-inline" checked="checked" type="radio" name="rte" value="No"  required>No</label>
                                            </div>
                                            <span class="text-danger"></span>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input id="father_occup" name="father_occup" placeholder="" type="text" class="form-control"  value="" />
                                                <span class="text-danger"></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input id="mother_occup" name="mother_occup" placeholder="" type="text" class="form-control"  value="" />
                                                <span class="text-danger"></span>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="guardian_occup" name="guardian_occup" placeholder="" type="text" class="form-control"  value="" />
                                                        <span class="text-danger"></span>
                                                    </div>
                                                </div>
                                            </div>
